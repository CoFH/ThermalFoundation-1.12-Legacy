...
public class EE3Plugin {
    ...
    public static void initialize() throws Throwable {
        ...
        EE3Helper.addRecipe(ItemHelper.cloneStack(TFItems.dustSignalum, 4),
                TFItems.dustCopper, TFItems.dustCopper, TFItems.dustCopper, TFItems.dustSilver,
                new FluidStack(TFFluids.fluidRedstone, 1000));

        EE3Helper.addRecipe(ItemHelper.cloneStack(TFItems.dustLumium, 4),
                TFItems.dustTin, TFItems.dustTin, TFItems.dustTin, TFItems.dustSilver,
                new FluidStack(TFFluids.fluidGlowstone, 1000));

        EE3Helper.addRecipe(ItemHelper.cloneStack(TFItems.dustEnderium, 4),
                TFItems.dustTin, TFItems.dustTin, TFItems.dustSilver, TFItems.dustPlatinum,
