...
public class GuiHandler implements IGuiHandler {
	...
	public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
		...
		case LEXICON_STUDY_ID:
			if (ItemHelper.isPlayerHoldingItem(ItemLexicon.class, player)) {
				return new GuiLexiconStudy(player.inventory, new ContainerLexiconStudy(player.getHeldItemMainhand(), player.inventory)); //TODO look into handling lexicon in offhand
			}
	...
	public Object getServerGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
		...
		case LEXICON_STUDY_ID:
			if (ItemHelper.isPlayerHoldingItem(ItemLexicon.class, player)) {
				return new ContainerLexiconStudy(player.getHeldItemMainhand(), player.inventory); //TODO look into handling lexicon in offhand
			}
		case LEXICON_TRANSMUTE_ID:
			if (ItemHelper.isPlayerHoldingItem(ItemLexicon.class, player)) {
