...
public class TFEquipment {
	...
	/* MATERIALS */
	public static final ArmorMaterial ARMOR_MATERIAL_COPPER = EnumHelper.addArmorMaterial("TF:COPPER", "copper_armor", 6, new int[] { 1, 3, 3, 1 }, 6, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2F);
	public static final ArmorMaterial ARMOR_MATERIAL_TIN = EnumHelper.addArmorMaterial("TF:TIN", "tin_armor", 8, new int[] { 1, 4, 3, 1 }, 7, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2F);
	public static final ArmorMaterial ARMOR_MATERIAL_SILVER = EnumHelper.addArmorMaterial("TF:SILVER", "silver_armor", 11, new int[] { 2, 4, 4, 1 }, 20, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 2F);
	public static final ArmorMaterial ARMOR_MATERIAL_LEAD = EnumHelper.addArmorMaterial("TF:LEAD", "lead_armor", 15, new int[] { 2, 5, 4, 3 }, 9, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2F);
	public static final ArmorMaterial ARMOR_MATERIAL_NICKEL = EnumHelper.addArmorMaterial("TF:NICKEL", "nickel_armor", 15, new int[] { 2, 5, 5, 2 }, 18, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2F);
	public static final ArmorMaterial ARMOR_MATERIAL_ELECTRUM = EnumHelper.addArmorMaterial("TF:ELECTRUM", "electrum_armor", 8, new int[] { 2, 4, 4, 2 }, 30, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 2F);
	public static final ArmorMaterial ARMOR_MATERIAL_INVAR = EnumHelper.addArmorMaterial("TF:INVAR", "invar_armor", 21, new int[] { 2, 7, 5, 2 }, 16, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2F);
	public static final ArmorMaterial ARMOR_MATERIAL_BRONZE = EnumHelper.addArmorMaterial("TF:BRONZE", "bronze_armor", 18, new int[] { 3, 6, 6, 2 }, 15, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2F);
	...
	public enum ArmorSet implements IModelRegister {
		...
		protected void preInit() {
			...
			enable = ThermalFoundation.CONFIG.getConfiguration().get(category, "Armor", true).getBoolean(true);

			enable &= !TFProps.disableAllArmor;
		...
		public void registerModel(Item item, String name) {
			...
			ModelLoader.setCustomModelResourceLocation(item, 0, new ModelResourceLocation(ThermalFoundation.MOD_ID + ":" + name, "inventory"));
		}
		...
		public void registerModels() {
			...
			registerModel(itemHelmet, name + "/" + name + "_helmet");
			registerModel(itemPlate, name + "/" + name + "_chestplate");
			registerModel(itemLegs, name + "/" + name + "_leggings");
			registerModel(itemBoots, name + "/" + name + "_boots");
		}
	}
	...
	public enum ToolSet implements IModelRegister {
		...
		public void registerModels() {
			...
			registerModel(itemSword, name + "/" + name + "_sword");
			registerModel(itemShovel, name + "/" + name + "_shovel");
			registerModel(itemPickaxe, name + "/" + name + "_pickaxe");
			registerModel(itemAxe, name + "/" + name + "_axe");
			registerModel(itemBow, name + "/" + name + "_bow");
			registerModel(itemFishingRod, name + "/" + name + "_fishing_rod");
			registerModel(itemSickle, name + "/" + name + "_sickle");
			registerModel(itemHammer, name + "/" + name + "_hammer");
			registerModel(itemShield, name + "/" + name + "_shield");
		}
	}
	...
	public enum ToolSetVanilla implements IModelRegister {
		...
		protected void preInit() {
			...
			itemShield.setShowInCreative(enable[5] | TFProps.showDisabledEquipment);
			itemShield.setRegistryName("tool.shield_" + name);
			GameRegistry.register(itemShield);
		...
		public void registerModels() {
			...
			if (itemShears instanceof ItemShearsAdv) {
				registerModel(itemShears, name + "/" + name + "_shears");
			}
			registerModel(itemSickle, name + "/" + name + "_sickle");
			registerModel(itemHammer, name + "/" + name + "_hammer");
			registerModel(itemShield, name + "/" + name + "_shield");
